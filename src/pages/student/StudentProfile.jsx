...
const StudentProfile = () => {
    ...
    const PasswordChangeModal = () => {
        ...
        const handleLocalSubmit = async (e) => {
            ...
            try {
                await changePassword(localPasswordData);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="col-span-1">
                            <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-blue-600 mx-auto">
                                {profileData.avatar ? (
                                    <img
                                        src={`https://savefiles.org/${profileData.avatar}?shareable_link=485`}
                                        alt="Profile"
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {classData ? (
                                        <>
                                            <div>
                                                <label className="text-sm text-gray-500 dark:text-gray-400">Class Number</label>
                                                <p className="text-gray-800 dark:text-white font-medium">{classData.classNumber}</p>
                                            </div>
                                            <div>
                                                <label className="text-sm text-gray-500 dark:text-gray-400">Class Category</label>
                                                <p className="text-gray-800 dark:text-white font-medium">{classData.classCategory}</p>
                                            </div>
                                        </>
                                    ) : (

...
const StudentSchedule = () => {
  ...
  const scheduleData = {
    'Monday': [
      ...
      { time: '11:00 AM - 12:30 PM', subject: 'Physics', teacher: 'Prof. Johnson', room: 'Lab 203' },
    ],
    'Tuesday': [
      { time: '9:00 AM - 10:30 AM', subject: 'English Literature', teacher: 'Ms. Davis', room: 'Room 105' },
    ],
    'Wednesday': [
      { time: '9:00 AM - 10:30 AM', subject: 'Mathematics', teacher: 'Dr. Smith', room: 'Room 101' },
      { time: '2:00 PM - 3:30 PM', subject: 'Physics Lab', teacher: 'Prof. Johnson', room: 'Lab 2' },
    ],
    'Thursday': [
      { time: '11:00 AM - 12:30 PM', subject: 'English Literature', teacher: 'Ms. Davis', room: 'Room 105' },
    ],
    'Friday': [
      { time: '9:00 AM - 10:30 AM', subject: 'Mathematics', teacher: 'Dr. Smith', room: 'Room 101' },
      { time: '11:00 AM - 12:30 PM', subject: 'Physics', teacher: 'Prof. Johnson', room: 'Lab 203' },
